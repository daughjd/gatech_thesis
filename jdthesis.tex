...
\firstreader{Professor Nepomuk Otte}[School of Physics][Georgia Institute of Technology]
...
%Like standard long-duration GRBs, choked GRB events are thought to arise from the core-collapse of massive star. Rapid accretion of stellar material onto the compact remnant produced during core-collapse may result in the formation of relativistic jets capable of accelerating charged particles to very high energies. In the standard GRB scenario, this jet will eventually breach the surrounding stellar material and give rise to a powerful gamma-ray signature. The rate of occurrence of GRBs in the nearby universe is quite low, but it may be possible that jet formation occurs in an appreciable fraction of core-collapse supernovae. If the jets are insufficiently energetic, then they will fail to breakout of the stellar envelope and lack any gamma ray signature.
